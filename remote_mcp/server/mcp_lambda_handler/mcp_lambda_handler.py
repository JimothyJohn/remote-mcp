...
class MCPLambdaHandler:
    ...
    def handle_request(self, event: Dict, context: Any) -> Dict:
        ...
        try:
            ...
            try:
                # AI-generated change: Safely handle missing request body.
                # A None body would cause a TypeError with json.loads.
                # Instead, we now check for a None body and return a
                # specific JSON-RPC error.
                body_str = event.get("body")
                if body_str is None:
                    return self._create_error_response(
                        -32600, "Invalid Request: body is missing", request_id
                    )
